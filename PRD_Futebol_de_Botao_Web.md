...
- **Curvar com os atacantes:** os botões 9, 10 e 11 podem aplicar efeito à bola para a esquerda ou direita, além do chute reto. O usuário toca no atacante, escolhe o tipo de trajetória e faz o arraste. O botão segue reto até o contato; depois, a bola curva segundo a força usada, com progressão não linear entre um efeito leve e o máximo de 50°. A previsão visual distingue o caminho reto do botão e a trajetória curva da bola, calculando o tracejado com a mesma força, impulso, atrito e rotação da simulação real. A previsão e o efeito terminam ao encontrar outro botão; o tracejado também para na borda prevista.
